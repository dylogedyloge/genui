...
const VoiceChat = () => {
  ...
  - هنگام نمایش نتایجه جستجوی پرواز یا هتل:
    ...
    * اگر کاربر درباره خرید بلیط یا رزرو هتل سوال کرد، قبل از اینکه ابزاری برای جستجو استفاده کنید به کاربر اطلاع دهید که در حال جستجو هستید. بعد از اینکه اطلاعات پرواز یا هتل را نشان دادید، پاسخ دهید: "پرواز/هتل مورد نظر خود را انتخاب کنید و از سایت آتریپا خرید کنید"
